    ...
    describe(`${resource.label}`, () => {
      describe(`List page`, () => {
        ...
        it('should have show buttons', async () => {
          await page.waitForSelector(showButtonSel, { visible: true });
          expect(await page.$(showButtonSel)).toBeTruthy();
        });
        it('should have edit buttons', async () => {
          await page.waitForSelector(editButtonSel, { visible: true });
          expect(await page.$(editButtonSel)).toBeTruthy();
        });
        it('should have a create button', async () => {
          await page.waitForSelector(createButtonSel, { visible: true });
      ...
      describe(`Edit page`, () => {
        ...
        it('should have a delete button', async () => {
          await page.waitForSelector(deleteButtonSel, { visible: true });
