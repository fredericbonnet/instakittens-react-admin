...
Then(
  ...
  async function() {
    await this.page.waitForSelector(usernameHelperSel, { visible: true });
...
Then(
  ...
  async function() {
    await this.page.waitForSelector(usernameHelperSel, { hidden: true });
...
Then('the Login Form should have a Password Input', async function() {
  await this.page.waitForSelector(passwordInputSel, { visible: true });
...
Then(
  ...
  async function() {
    await this.page.waitForSelector(passwordHelperSel, { visible: true });
...
Then(
  ...
  async function() {
    await this.page.waitForSelector(passwordHelperSel, { hidden: true });
...
Then('the Login Form should have a Sign In Button', async function() {
  await this.page.waitForSelector(loginSubmitButtonSel, { visible: true });
...
Then('I should see a Warning Message', async function() {
  await this.page.waitForSelector(warningSel, { visible: true });
  expect(await this.page.$(warningSel)).to.exist;
});
Then('I should not see a Warning Message', async function() {
  await this.page.waitForSelector(warningSel, { hidden: true });
